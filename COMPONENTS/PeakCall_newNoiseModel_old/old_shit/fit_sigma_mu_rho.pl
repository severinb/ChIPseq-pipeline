...
my $win_fg = $ARGV[2]; # window length foreground
my $win_bg = $ARGV[3]; #               background
my $DIR = $ARGV[4]; # output directory

# get the window lengths used for the sliding window (bg and fg)

print STDERR "The fg window length is $win_fg\n";
print STDERR "The bg window length is $win_bg\n";
